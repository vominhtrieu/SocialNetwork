...
import { Box, Typography, makeStyles, withStyles, Tooltip } from '@material-ui/core';
...
export default function ReceiveMessage(props) {
  ...
  return (
    <Box display='flex' alignItems='center' justifyContent='flex-start' marginBottom={0.5}>
      ...
      <LightTooltip title={moment(message.date).format('DD-MM-YYYY hh:mm')} placement='right'>
